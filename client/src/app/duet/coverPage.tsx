...
const CoverPage: React.FC = () => {
    const { startMatch, loading, waiting, cancelMatch, rooms, initload, joinMatch } = useSocket();
    ...
    return (
        ...
        >
            ...
            >
                <div>
                    skip <input
                        className=" select-none m-1 mr-2  p-1 bg-gray-700 rounded outline-none text-white placeholder-gray-500"
                        type="number"
                        placeholder="skip"
                        defaultValue={0}
                        min={0}
